...
const HeroSection: React.FC = () => {
  return (
    <section className="mt-32 mb-36 flex justify-between items-center px-44 py-0 w-full max-w-[1920px] max-md:px-20 max-sm:px-10 max-sm:flex-col max-sm:gap-10">
      ...
      <img
        ...
        className="h-[722px] w-[1122px] max-md:h-auto max-md:w-[800px] max-sm:h-auto max-sm:w-[600px]"
        alt="Smartphone"
      />
    </section>
  );
