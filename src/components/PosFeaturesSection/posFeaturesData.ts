export const posFeaturesData = {
  finalTitle: "Tudo e muito mais, em uma <span>única</span> plataforma",
  ...
  features: [
    {
      ...
      descriptionPoints: [
        ...
        'Veja todo o histórico de vendas de cada funcionário',
      ],
    },
    {
      ...
      descriptionPoints: [
        ...
        'Criação de Planilhas com um único clique',
        'Filtro de acordo com o Token ou tipo de movimentação.',
      ],
    },
    {
    ...
    },
    {
      ...
      descriptionPoints: [
        ...
        'Veja os detalhes incluindo o preço do Token em R$',
      ],
    },
  ],
};
